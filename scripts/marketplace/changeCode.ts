...
import { Marketplace, marketplaceConfigToCell, subscriptionInfoValueParser, userSubscriptionValueParser } from '../../wrappers/Marketplace';
...
export async function run(provider: NetworkProvider) {
    const marketplace = provider.open(Marketplace.createFromAddress(Address.parse("EQA7QIKU3j1ipe88gg8euLxKupXEjc_czkigjw9mpZ5qXT8N")));
    ...
    await marketplace.sendChangeCode(provider.sender(), code, data);
}